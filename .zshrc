...
# Try to fix issue where history with 9999* causes history entry to include
# 9999* when selected.
# https://github.com/junegunn/fzf/blame/1a9ea6f738cfafab83a5e0e828e60f0bf68bffee/shell/key-bindings.zsh#L101
# Started around fzf 0.45
fzf-history-widget() {
  local selected num
